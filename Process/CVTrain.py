...
if __name__ == '__main__':
    ...
    data_root = r'/home/zhangyihong/Documents/BreastNpyCorrect'
    device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')

    EnsembleTrain(device, model_root, 'ResNet3D_20220224', data_root, type_list=['Adc', 'Eser', 'T2'])
    EnsembleTrain(device, model_root, 'ResNet3D_20220224_Adc', data_root, type_list=['Adc'])
    EnsembleTrain(device, model_root, 'ResNet3D_20220224_Eser', data_root, type_list=['Eser'])
    EnsembleTrain(device, model_root, 'ResNet3D_20220224_T2', data_root, type_list=['T2'])
